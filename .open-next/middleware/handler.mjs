...
var require_prerender_manifest = __commonJS({
  ".next/prerender-manifest.js"() {
    "use strict";
    self.__PRERENDER_MANIFEST = '{"version":4,"routes":{"/login":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/login","dataRoute":"/login.rsc"},"/":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/","dataRoute":"/index.rsc"},"/track":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/track","dataRoute":"/track.rsc"},"/reset-password":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/reset-password","dataRoute":"/reset-password.rsc"},"/verify-email":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/verify-email","dataRoute":"/verify-email.rsc"},"/dashboard":{"experimentalBypassFor":[{"type":"header","key":"Next-Action"},{"type":"header","key":"content-type","value":"multipart/form-data;.*"}],"initialRevalidateSeconds":false,"srcRoute":"/dashboard","dataRoute":"/dashboard.rsc"}},"dynamicRoutes":{},"notFoundRoutes":[],"preview":{"previewModeId":"process.env.__NEXT_PREVIEW_MODE_ID","previewModeSigningKey":"process.env.__NEXT_PREVIEW_MODE_SIGNING_KEY","previewModeEncryptionKey":"process.env.__NEXT_PREVIEW_MODE_ENCRYPTION_KEY"}}';
  }
});
...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[826], { 67: (e) => {
      ...
      r.r(b), r.d(b, { config: () => eU, middleware: () => eV });
      let v = null;
      function w() {
        return v || (v = m()), v;
      }
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let R = Symbol("response"), N = Symbol("passThrough"), T = Symbol("waitUntil");
      class C {
        constructor(e2) {
          this[T] = [], this[N] = false;
        }
      ...
      class B {
        constructor(e2, t2, r2) {
          let n2, i2;
          "object" == typeof t2 && "pathname" in t2 || "string" == typeof t2 ? (n2 = t2, i2 = r2 || {}) : i2 = r2 || t2 || {}, this[U] = { url: V(e2, n2 ?? i2.base), options: i2, basePath: "" }, this.analyze();
        }
        analyze() {
          var e2, t2, r2, n2, i2;
        ...
        formatPathname() {
          ...
          }((e2 = { basePath: this[U].basePath, buildId: this[U].buildId, defaultLocale: this[U].options.forceLocale ? void 0 : this[U].defaultLocale, locale: this[U].locale, pathname: this[U].url.pathname, trailingSlash: this[U].trailingSlash }).pathname, e2.locale, e2.buildId ? void 0 : e2.defaultLocale, e2.ignorePrefix), (e2.buildId || !e2.trailingSlash) && (t2 = M(t2)), e2.buildId && (t2 = L(A(t2, "/_next/data/" + e2.buildId), "/" === e2.pathname ? "index.json" : ".json")), t2 = A(t2, e2.basePath), !e2.buildId && e2.trailingSlash ? t2.endsWith("/") ? t2 : L(t2, "/") : M(t2);
        }
        formatSearch() {
        ...
        clone() {
          return new B(String(this), this[U].options);
        }
      }
      var q = r(447);
      ...
      class G extends Request {
        constructor(e2, t2 = {}) {
          ...
          let n2 = new B(r2, { headers: P(this.headers), nextConfig: t2.nextConfig });
          this[$] = { cookies: new q.RequestCookies(this.headers), geo: t2.geo || {}, ip: t2.ip, nextUrl: n2, url: n2.toString() };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      class W extends Response {
        constructor(e2, t2 = {}) {
          super(e2, t2), this[H] = { cookies: new q.ResponseCookies(this.headers), url: t2.url ? new B(t2.url, { headers: P(this.headers), nextConfig: t2.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static redirect(e2, t2) {
          ...
          return i2.set("Location", O(e2)), new W(null, { ...n2, headers: i2, status: r2 });
        }
        static rewrite(e2, t2) {
          let r2 = new Headers(null == t2 ? void 0 : t2.headers);
          return r2.set("x-middleware-rewrite", O(e2)), z(t2, r2), new W(null, { ...t2, headers: r2 });
        }
        static next(e2) {
          let t2 = new Headers(null == e2 ? void 0 : e2.headers);
          return t2.set("x-middleware-next", "1"), z(e2, t2), new W(null, { ...e2, headers: t2 });
        }
      }
      function K(e2, t2) {
      ...
      let eL = { keys: (e2) => Array.from(e2.keys()), get: (e2, t2) => e2.get(t2) ?? void 0 }, ek = (e2, t2) => eT().withPropagatedContext(e2.headers, t2, eL), ej = false;
      async function eD(e2) {
        ...
        let o2 = new B(e2.request.url, { headers: e2.request.headers, nextConfig: e2.request.nextConfig });
        ...
        }(o2, true).toString(), init: { body: e2.request.body, geo: e2.request.geo, headers: u2, ip: e2.request.ip, method: e2.request.method, nextConfig: e2.request.nextConfig, signal: e2.request.signal } });
        l2 && Object.defineProperty(c2, "__isData", { enumerable: false, value: true }), !globalThis.__incrementalCache && e2.IncrementalCache && (globalThis.__incrementalCache = new e2.IncrementalCache({ appDir: true, fetchCache: true, minimalMode: true, fetchCacheKeyPrefix: "", dev: false, requestHeaders: e2.request.headers, requestProtocol: "https", getPrerenderManifest: () => ({ version: -1, routes: {}, dynamicRoutes: {}, notFoundRoutes: [], preview: { previewModeId: "development-id" } }) }));
        let p2 = new E({ request: c2, page: e2.page });
        if ((t2 = await ek(c2, () => "/middleware" === e2.page || "/src/middleware" === e2.page ? eT().trace(f.execute, { spanName: `middleware ${c2.method} ${c2.nextUrl.pathname}`, attributes: { "http.target": c2.nextUrl.pathname, "http.method": c2.method } }, () => eM.wrap(eI, { req: c2, renderOpts: { onUpdateCookies: (e3) => {
          n2 = e3;
        }, previewProps: (null == a2 ? void 0 : a2.preview) || { previewModeId: "development-id", previewModeEncryptionKey: "", previewModeSigningKey: "" } } }, () => e2.handler(c2, p2))) : e2.handler(c2, p2))) && !(t2 instanceof Response)) throw TypeError("Expected an instance of Response to be returned");
        t2 && n2 && t2.headers.set("set-cookie", n2);
        let g2 = null == t2 ? void 0 : t2.headers.get("x-middleware-rewrite");
        if (t2 && g2 && !i2) {
          let r2 = new B(g2, { forceLocale: true, headers: e2.request.headers, nextConfig: e2.request.nextConfig });
        ...
        if (t2 && h2 && !i2) {
          let r2 = new B(h2, { forceLocale: false, headers: e2.request.headers, nextConfig: e2.request.nextConfig });
        ...
        return { response: b2, waitUntil: Promise.all(p2[T]), fetchMetrics: c2.fetchMetrics };
      }
      function eV(e2) {
        let t2 = e2.nextUrl.pathname, r2 = t2.startsWith("/dashboard"), n2 = e2.cookies.get("token")?.value;
        return r2 && !n2 ? W.redirect(new URL("/login", e2.url)) : "/login" === t2 && n2 ? W.redirect(new URL("/dashboard", e2.url)) : W.next();
      }
      r(568), "undefined" == typeof URLPattern || URLPattern;
      let eU = { matcher: ["/dashboard/:path*", "/login"] }, eB = { ...b }, eq = eB.middleware || eB.default, e$ = "/middleware";
      if ("function" != typeof eq) throw Error(`The Middleware "${e$}" must export a \`middleware\` or a \`default\` function`);
      function eG(e2) {
        return eD({ ...e2, page: e$, handler: eq });
      }
    }, 447: (e) => {
      "use strict";
      ...
      (() => {
        ...
        (() => {
          ...
          Object.defineProperty(a, "trace", { enumerable: true, get: function() {
            return x.trace;
          } }), a.default = { context: v.context, diag: w.diag, metrics: y.metrics, propagation: _.propagation, trace: x.trace };
        })(), e.exports = a;
      })();
    }, 373: (e) => {
      (() => {
      ...
      (() => {
        var i = { 226: function(i2, a2) {
          !function(o2, s2) {
            "use strict";
            var l = "function", u = "undefined", d = "object", c = "string", p = "major", g = "model", h = "name", f = "type", b = "vendor", m = "version", v = "architecture", w = "console", y = "mobile", _ = "tablet", x = "smarttv", S = "wearable", P = "embedded", O = "Amazon", R = "Apple", N = "ASUS", T = "BlackBerry", C = "Browser", E = "Chrome", M = "Firefox", I = "Google", A = "Huawei", L = "Microsoft", k = "Motorola", j = "Opera", D = "Samsung", V = "Sharp", U = "Sony", B = "Xiaomi", q = "Zebra", $ = "Facebook", G = "Chromium OS", H = "Mac OS", F = function(e2, t2) {
              var r2 = {};
            ...
            ee.VERSION = "1.0.35", ee.BROWSER = z([h, m, p]), ee.CPU = z([v]), ee.DEVICE = z([g, b, f, w, y, x, _, S, P]), ee.ENGINE = ee.OS = z([h, m]), typeof a2 !== u ? (i2.exports && (a2 = i2.exports = ee), a2.UAParser = ee) : r.amdO ? void 0 !== (n = function() {
              return ee;
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/login(.json)?[\\/#\\?]?$"] }];
