...
export default function Home() {
  ...
  return (
    <main className="w-full bg-background min-h-screen text-foreground selection:bg-primary/30 overflow-x-hidden">
      ...
      {/* 7. TRACK YOUR VEHICLE (SECTION & FORM) */}
      <section id="track" className="py-24 bg-surface-50 border-t border-border">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3">{t.trackSecTitle}</h2>
            <p className="text-xs md:text-sm text-secondary max-w-2xl mx-auto leading-relaxed">{t.trackSecDesc}</p>
            <div className="w-16 h-1 bg-primary mx-auto mt-4" />
          </div>

          <div className="bg-white border border-border rounded-2xl p-8 md:p-10 shadow-xl">
            <form onSubmit={handleQuickTrackSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className={`w-full bg-surface-50 border border-border rounded-lg ${lang === 'ar' ? 'pr-10 pl-4' : 'pl-10 pr-4'} py-3.5 text-sm font-mono tracking-wider focus:outline-none focus:border-primary transition-all text-foreground`}
              ...
              <div className="pt-2">
                <button 
                  type="submit"
                  className="w-full bg-primary text-white font-bold rounded-lg py-4 hover:bg-brand-hover transition-all flex items-center justify-center gap-2 text-sm uppercase tracking-wider shadow-md"
                >
